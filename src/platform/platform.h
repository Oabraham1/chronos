 ...
 *
 * This file defines the abstract base class for platform-specific
 * operations, allowing the core Chronos code to be platform-independent.
 *
...
public:
   ...
   * @return True if successful, false otherwise
   */
  virtual bool createLockFile(const std::string &path,
