 ...
 *
 * This file provides a platform-specific include for the OpenCL headers.
 * It also includes a mock implementation of the OpenCL API for continuous
 * integration environments where OpenCL may not be available.
 *
...
inline cl_context clCreateContext(const cl_context_properties *properties,
                                  cl_uint num_devices,
