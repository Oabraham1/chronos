...
public:
   ...
   */
  static std::string
  formatIso8601(const std::chrono::system_clock::time_point &time);
   ...
   */
  static std::string
  formatHumanReadable(const std::chrono::system_clock::time_point &time);
  ...
  parseIso8601(const std::string &isoString);
