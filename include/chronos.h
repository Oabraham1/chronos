 ...
 *
 * This file contains the main declarations for the Chronos library,
 * including the ChronosPartitioner class which provides the primary
 * interface for managing GPU partitions.
 *
